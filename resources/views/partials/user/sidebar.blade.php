                ...
                <a href="{{ route('user.home') }}"
                   class="relative flex items-center px-3 py-2.5 rounded-lg transition duration-150 ease-in-out group
                    ...
                    <div class="flex gap-3 items-center group">
                        <span class="iconify w-6 h-6 flex-shrink-0 {{ request()->routeIs('user.home*') ? 'text-black' : 'text-white group-hover:text-black' }}" data-icon="famicons:home"></span>
                        <span class="text-md">Beranda</span>
                    </div>
                </a>
            </li>
            <li>
