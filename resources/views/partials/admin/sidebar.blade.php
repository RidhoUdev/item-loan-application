                ...
                <a href="{{ route('admin.items.index') }}"
                   class="relative flex items-center px-3 py-2.5 rounded-lg transition duration-150 ease-in-out group
                    ...
                    <div class="flex gap-3 items-center">
                        <span class="iconify w-6 h-6 flex-shrink-0 {{ request()->routeIs('admin.items.index*') ? 'text-black' : 'text-white group-hover:text-black' }}" data-icon="solar:box-linear"></span>
                ...
                <a href="{{ route('admin.categories.index') }}"
                   class="relative flex items-center px-3 py-2.5 rounded-lg transition duration-150 ease-in-out group
                    ...
                    <div class="flex items-center gap-3">
                        <span class="iconify w-6 h-6 flex-shrink-0 {{ request()->routeIs('admin.categories.index*') ? 'text-black' : 'text-white group-hover:text-black' }}" data-icon="fa6-solid:layer-group"></span>
                        Kategori
                    </div>
                </a>
            </li>
